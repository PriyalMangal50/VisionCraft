...
const Footer = () => {
  return (
    <footer className="font-sans bg-gradient-to-b from-gray-50 to-gray-100 mt-24 w-full border-t border-gray-200 relative">
      {/* Decorative top edge */}
      <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-accent-400 via-primary-700 to-secondary-500"></div>
        ...
        <div className="py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-8 gap-y-12">
          ...
          <div className="space-y-6">
            <Link to="/" className="inline-block">
              <img 
                className="w-36 transition-transform hover:scale-105 duration-300" 
                src={assets.logo} 
            ...
            <div className="flex space-x-3">
              <a 
                href="#" 
                aria-label="Twitter" 
                className="w-10 h-10 rounded-full bg-white shadow-sm border border-gray-100 flex items-center justify-center text-gray-600 hover:bg-primary-700 hover:text-white hover:border-primary-700 transition-all duration-200"
              >
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/collection" className="text-gray-600 hover:text-primary-700 transition-colors flex items-center gap-2">
                  <svg className="w-3 h-3 text-primary-700" fill="currentColor" viewBox="0 0 24 24"><path d="M9 5l7 7-7 7"></path></svg>
                  All Products
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-gray-600">
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-primary-700 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span>9795XXXXXX</span>
              </li>
              <li className="flex items-center gap-2">
                <svg className="w-4 h-4 text-primary-700 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span>visioncraft@gmail.com</span>
              </li>
              <li className="mt-4">
      ...
      {/* Newsletter Section */}
      <div className="w-full py-12 bg-gradient-to-br from-primary-700 to-primary-800">
        <div className="px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] max-w-screen-2xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="max-w-lg">
              <h3 className="text-2xl font-display font-semibold text-white mb-2">Join Our Newsletter</h3>
              <p className="text-primary-200">Get updates on new products, special offers and style inspiration.</p>
            </div>
            ...
            <div className="w-full lg:w-auto">
              <form className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
                <input
                  ...
                  className="input bg-white/10 text-white border-white/20 placeholder:text-white/50 focus:border-white focus:ring-white/30"
                />
                <button className="btn bg-accent-500 hover:bg-accent-600 text-white whitespace-nowrap transition-colors">
                  Subscribe
      ...
      <div className="bg-primary-700 text-gray-300 w-full">
        <div className="px-4 sm:px-[5vw] md:px-[7vw] lg:px-[9vw] max-w-screen-2xl mx-auto">
          <div className="py-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm">
              &copy; {new Date().getFullYear()} VisionCraft. All rights reserved.
            </p>
            <div className="flex items-center space-x-6 text-sm">
              <a href="#" className="hover:text-white transition-colors">Privacy Policy</a>
              <a href="#" className="hover:text-white transition-colors">Terms of Service</a>
              <a href="#" className="hover:text-white transition-colors">Shipping Policy</a>
              <p className="text-gray-300">Made with ❤️ by <span className="font-medium text-accent-300">Priyal</span></p>
            </div>
          </div>
        </div>
      </div>

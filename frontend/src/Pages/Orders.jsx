        ...
        {orderData.map((item, i) => (
          <div key={i} className='py-4 border-t text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            <div className='flex items-start gap-6 text-sm'>
              <img className='w-16 sm:w-20' src={sanitizeImageUrl(item.image?.[0])} alt='imge' onError={(e) => { e.currentTarget.onerror = null; e.currentTarget.src = '/images/no_image.png'; }} />
              <div>

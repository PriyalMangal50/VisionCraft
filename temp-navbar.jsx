            ...
            <nav className='flex items-center justify-between font-medium content-container'>
                ...
                <div className='flex items-center gap-5'>
                    ...
                    <div className='group relative'>
                        ...
                        {token && (
                            <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-3 z-50 animate-fade-in'>
                                <div className='flex flex-col gap-3 w-48 py-4 px-5 bg-white text-gray-dark rounded-lg shadow-dropdown border border-light-gray'>
                    ...
                    <Link to='/cart' className='relative'>
                        <button className="w-10 h-10 rounded-full hover:bg-primary-light flex items-center justify-center transition-colors" aria-label="Cart">
                            <svg className="w-5 h-5 text-gray-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path>
                            </svg>
                            {getCartCount() > 0 && (
                                <span className='absolute right-1 top-1 w-5 h-5 flex items-center justify-center bg-primary text-white rounded-full text-xs font-bold'>
                                    {getCartCount()}
                                </span>
                            )}
                        </button>
                    ...
                    <button
                        ...
                        className='lg:hidden w-10 h-10 rounded-full hover:bg-primary-light flex items-center justify-center transition-colors'
                        aria-label="Menu"
                    >
